...
export class EndCrystal extends THREE.Object3D {
    constructor() {
        super();
        const CORE_SCALE = .6;
        this.inside = new THREE.Mesh(frameGeometry, commonMaterials[13 /* EndCrystalCore */]);
        this.inside.scale.set(CORE_SCALE, CORE_SCALE, CORE_SCALE);
        this.add(this.inside);
        const outside1 = new THREE.Mesh(frameGeometry, commonMaterials[14 /* EndCrystalFrame */]);
        const FRAME1_SCALE = .8;
        this.inside.scale.set(FRAME1_SCALE, FRAME1_SCALE, FRAME1_SCALE);
        outside1.rotateX(Math.PI / 4);
        this.add(outside1);
        this.outside2 = new THREE.Mesh(frameGeometry, commonMaterials[14 /* EndCrystalFrame */]);
