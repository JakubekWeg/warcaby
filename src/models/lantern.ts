...
const mainMaterial = commonMaterials[MaterialType.Lantern]
...
const createBottomPart = (): THREE.Geometry => {
	...
	g.faces.push(
		new THREE.Face3(4, 5, 6, normal),
		new THREE.Face3(6, 7, 4, normal),
	)
	// bottom/top UV
	g.faceVertexUvs[0].push(
		[new THREE.Vector2(0, 1 / 16), new THREE.Vector2(0, 7 / 16), new THREE.Vector2(6 / 16, 7 / 16)],
		[new THREE.Vector2(0, 1 / 16), new THREE.Vector2(0, 7 / 16), new THREE.Vector2(6 / 16, 7 / 16)],
		[new THREE.Vector2(0, 1 / 16), new THREE.Vector2(0, 7 / 16), new THREE.Vector2(6 / 16, 7 / 16)],
		[new THREE.Vector2(0, 1 / 16), new THREE.Vector2(0, 7 / 16), new THREE.Vector2(6 / 16, 7 / 16)],
	)
	...
	g.faces.push(
		new THREE.Face3(0, 1, 4, normal),
		new THREE.Face3(4, 1, 5, normal),
	)

	normal = new THREE.Vector3(0, 0, 1)
	g.faces.push(
		new THREE.Face3(1, 2, 5, normal),
		new THREE.Face3(5, 2, 6, normal),
	)

	normal = new THREE.Vector3(1, 0, 0)
	g.faces.push(
		new THREE.Face3(2, 3, 6, normal),
		new THREE.Face3(6, 3, 7, normal),
	)

	normal = new THREE.Vector3(0, 0, -1)
	g.faces.push(
		new THREE.Face3(3, 0, 7, normal),
		new THREE.Face3(7, 0, 4, normal),
	)
...
const addTopPart = (g: THREE.Geometry) => {
	...
	g.faces.push(
		new THREE.Face3(vertexesStart + 4, vertexesStart + 5, vertexesStart + 6, normal),
		new THREE.Face3(vertexesStart + 6, vertexesStart + 7, vertexesStart + 4, normal),
	)
	// top/bottom UV
	g.faceVertexUvs[0].push(
		[new THREE.Vector2(1 / 16, 2 / 16), new THREE.Vector2(1 / 16, 6 / 16), new THREE.Vector2(5 / 16, 6 / 16)],
		[new THREE.Vector2(1 / 16, 2 / 16), new THREE.Vector2(1 / 16, 6 / 16), new THREE.Vector2(5 / 16, 6 / 16)],
	)
	...
	normal = new THREE.Vector3(-1, 0, 0)
	g.faces.push(
		new THREE.Face3(vertexesStart, vertexesStart + 1, vertexesStart + 4, normal),
		new THREE.Face3(vertexesStart + 4, vertexesStart + 1, vertexesStart + 5, normal),
	)

	normal = new THREE.Vector3(0, 0, 1)
	g.faces.push(
		new THREE.Face3(vertexesStart + 1, vertexesStart + 2, vertexesStart + 5, normal),
		new THREE.Face3(vertexesStart + 5, vertexesStart + 2, vertexesStart + 6, normal),
	)

	normal = new THREE.Vector3(1, 0, 0)
	g.faces.push(
		new THREE.Face3(vertexesStart + 2, vertexesStart + 3, vertexesStart + 6, normal),
		new THREE.Face3(vertexesStart + 6, vertexesStart + 3, vertexesStart + 7, normal),
	)

	normal = new THREE.Vector3(0, 0, -1)
	g.faces.push(
		new THREE.Face3(vertexesStart + 3, vertexesStart + 0, vertexesStart + 7, normal),
		new THREE.Face3(vertexesStart + 7, vertexesStart + 0, vertexesStart + 4, normal),
	)
...
const addHangingPart = (g: THREE.Geometry) => {
	const vertexesStart = g.vertices.length
...
export const getLanternMesh = (): THREE.Mesh => {
