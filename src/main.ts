...
const breakingBlockAnimation = new BreakingBlockAnimation(
	<HTMLCanvasElement>document.getElementById('animation-canvas'),
	<HTMLImageElement>document.getElementById('obsidian'),
	<HTMLImageElement>document.getElementById('pickaxe'),
)
...
const nickTextBox = <HTMLInputElement>document.getElementById('nick')
...
submitBtn.addEventListener('click', async () => {
	...
	switch (registrationStatus) {
		...
		case 200:
			...
			setNicksAndColors(nick, INSTANCE.networking.myType,
				INSTANCE.networking.opponentInfo.nick, INSTANCE.networking.opponentInfo.color)
